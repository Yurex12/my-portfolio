...
export default function Hero() {
  ...
  return (
    <section className="relative mt-20 flex h-[90dvh] w-full items-center justify-center border border-red-500">
      {/* === BACKGROUND ELEMENTS === */}
      ...
      <span className="text-secondary-foreground/10 float-slow absolute top-[10%] right-[20%] rotate-6 font-mono text-7xl select-none">
        {"[]"}
      </span>
